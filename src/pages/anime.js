  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Anime List - JoAnimeCode" />
        <meta property="og:description" content="Stay Disini Ya Pepek Untuk Update Animenya" />
        <meta property="og:image" content="https://JoAnimeCode.vercel.app/favicon.avif" />
        <meta property="og:url" content="https://JoAnimeCode.vercel.app/anime" />
              ...
              <>
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                  <div className="flex-1 bg-base-300 p-3 rounded-lg">
                    <div className="relative w-full pt-[56.25%]">
                      {selectedAnime.episodes && selectedAnime.episodes.length > 0 ? (
                        ...
                        <div className="absolute top-0 left-0 w-full h-full rounded-lg bg-base-100 flex items-center justify-center">
                          <p className="text-orange">Tidak Ada Episode</p>
                        </div>
                      )}
                    </div>
                    <select
                    ...
                    >
                      <option disabled>Pilih Episode</option>
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-4 flex flex-col flex-1 overflow-y-auto">
                        ...
                        <p className="text-xs sm:text-sm mt-1">
                          DURASI : {selectedAnime.infoItems?.find(item => item.startsWith("Durasi:"))?.split(":")[1]?.trim() || "-"}
                        </p>
                        <p className="text-xs sm:text-sm mt-1">
