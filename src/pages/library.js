  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Cari Dan Tonton Anime Kesukaanmu Atau Koleksi - JoAnimeCode" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Library - JoAnimeCode" />
        <meta property="og:description" content="Simpan Dan Manage Anime Favoritmu Di JoAnimeCode" />
        <meta property="og:image" content="https://joanimecode.vercel.app/favicon.avif" />
        <meta property="og:url" content="https://joanimecode.vercel.app/library" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="language" content="en" />
        <meta name="author" content="Rxvxn" />
        <link rel="canonical" href="https://joanimecode.vercel.app/library" />
      </Head>
      <Layout>
        {showToast && (
        ...
        <dialog id="delete_library" className="modal">
          <div className="modal-box border-orange border-2 rounded-lg">
            ...
            <h3 className="font-bold text-lg">HAPUS LIBRARY</h3>
            <p className="py-4">
              {isMultipleDelete
                ? "Kamu Yakin Hapus Perpustakaan Ini?"
                : "Kamu Yakin Untuk Hapus?"}
            </p>
                          ...
                          <div className="form-control">
                            <label className="cursor-pointer label">
                              <input
                                ...
                                className="checkbox [--chkbg:theme(colors.orange)] checkbox-xs bg-base-300"
                              />
                              <span className="sr-only">Pilih {anime.title}</span>
                            </label>
                          </div>
                        </td>
