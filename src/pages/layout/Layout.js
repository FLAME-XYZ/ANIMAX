...
const Layout = ({ children }) => {
  ...
  const socialLinks = [
    { icon: BsGithub, href: "https://github.com/FLAME-XD", label: "Github" },
    { icon: BsInstagram, href: "https://www.instagram.com/kzee10_/", label: "Instagram" },
      ...
      <div className="flex flex-col min-h-screen">
        <div className="navbar bg-base-200 fixed top-0 left-0 w-full z-50">
          ...
          <div className="navbar-center">
            <Link className="btn btn-ghost text-xl text-orange" href="/" aria-label="Go to homepage">JoAnimeCode</Link>
          </div>
          ...
          <div className="hero relative mt-16" style={{ backgroundImage: "url(/herosection.avif)" }}>
            ...
            <div className="py-14 hero-content text-neutral-content text-center relative">
              <div className="max-w-md">
                <h1 className="mb-3 text-3xl font-bold text-orange">JoAnimeCode</h1>
        ...
        <footer className={`footer footer-center bg-base-200 text-base-content rounded p-6 ${footerMarginClass}`}>
          ...
          <aside>
            <p>
              Copyright © {new Date().getFullYear()} - All rights reserved by <span className="text-orange">FLAME-XD As JOO .</span>
            </p>
          </aside>
        </footer>
        {router.pathname !== '/dev/dashboard' && (
